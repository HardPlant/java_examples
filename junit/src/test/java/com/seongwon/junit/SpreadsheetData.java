...
public class SpreadsheetData{
    ...
    Workbook workbook;
    public SpreadsheetData(final InputStream excelInputStream, boolean isXls) throws IOException{
        setWorkbook(excelInputStream, isXls);
        this.data = loadFromSpreadsheet();
    }
    public void setWorkbook(final InputStream excelFile, boolean isXls)
    throws IOException{
        if(isXls){
    ...
    private Collection loadFromSpreadsheet(){
